...
//Finalizar logica y exportar dsp:
export const getProductById = (req, res) => {
    res.json({ msg: "getProductById vacío" });
};

export const createProduct = (req, res) => {
    res.json({ msg: "createProduct vacío" });
};

export const modifyProduct = (req, res) => {
    res.json({ msg: "modifyProduct vacío" });
};

export const removeProduct = (req, res) => {
    res.json({ msg: "removeProduct vacío" });
};
